...
export default async function ShortsGeneratorPage() {
    ...
    const hasAccess = await checkEntitlement(workspace.id, 'module.shorts_generator')
            ...
            <div className="max-w-4xl mx-auto py-8 px-4">
                <div className="border rounded-lg p-8 text-center bg-gray-50 dark:bg-zinc-900 dark:border-zinc-800">
                    ...
                    <p className="text-gray-600 dark:text-zinc-400 mb-4">
                        Purchase the Viral Shorts Generator to create 60-second video scripts.
                    </p>
                    <a
                        href="/dashboard/modules"
                        className="inline-block bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-500"
                    >
                        Get Shorts Generator - $29
                    </a>
                </div>
            </div>
        )
